const openings = [
  {
    title: "Construction Inspector (Aviation)",
    type: "Full-Time",
    location: "Statewide, IN",
    description: "Field inspection of airfield construction, FAA P-401 HMA paving, airfield lighting, and quality assurance on active runways and taxiways. Night-shift work during runway closures required.",
    requirements: ["3+ years field inspection experience", "Familiarity with FAA standards a plus", "Willingness to work overnight closures", "Valid driver's license"],
  },
  {
  ...
  {
    title: "Construction Inspector (Wastewater)",
    type: "Full-Time",
    location: "Statewide, IN",
    description: "Specialized inspection of wastewater treatment, lift station, and force main construction. Multi-discipline exposure to structural, mechanical, and electrical scopes.",
    requirements: ["3+ years treatment plant or utility inspection", "Familiarity with IDEM requirements", "Experience with commissioning support", "Strong documentation skills"],
  },
  {
    title: "Resident Project Representative",
    type: "Full-Time",
    location: "Indianapolis, IN",
    description: "Serve as the owner's representative in the field, handling daily reports, contract administration, pay application review, change orders, and closeout. Client-facing role with strong communication skills.",
    requirements: ["5+ years construction inspection or contract administration", "Experience with public agency clients", "Familiarity with pay apps and change orders", "INDOT certification or PE preferred"],
  },
  {
    title: "Inspection Intern",
    type: "Internship · Summer",
    location: "Indianapolis, IN",
    description: "Gain hands-on experience supporting field inspection and quality assurance teams. Open to undergraduate and graduate students in Civil, Environmental, or Construction programs.",
    requirements: ["Enrolled in accredited program", "Sophomore standing or above", "Eagerness to learn field inspection work", "Indiana-based strongly preferred"],
  },
];
...
const values = [
  ...
  {
    title: "Indiana Roots",
    body: "We're focused on Indiana infrastructure. That means staying connected to local communities, agencies, and the people who build this state.",
  },
];
      ...
      <section className="relative overflow-hidden" style={{ backgroundColor: "var(--fgi-navy)", minHeight: "48vh" }}>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-24 md:py-32">
          ...
          <p className="text-white/70 text-lg max-w-xl leading-relaxed">
            FGI is growing. We're looking for inspectors and field professionals who take pride in infrastructure done right.
          </p>
        </div>
      </section>
