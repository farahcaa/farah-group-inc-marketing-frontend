export default function Head() {
  ...
  return (
    <>
      ...
      <meta
        name="keywords"
        content="construction inspection, quality assurance, contract administration, owner's representative, aviation inspection, FAA P-401, wastewater inspection, transportation inspection, infrastructure, FGI"
      />
