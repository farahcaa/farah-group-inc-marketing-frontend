...
const gallery = [
  "/bridgeport-interceptor-1.jpg",
  "/bridgeport-interceptor-2.jpg",
  "/bridgeport-interceptor-3.jpg",
];
  ...
  return (
    <>
      <section className="relative overflow-hidden" style={{ backgroundColor: "var(--fgi-navy)", minHeight: "56vh" }}>
        <img src="/bridgeport-interceptor-4.jpg" alt="" className="absolute inset-0 w-full h-full object-cover opacity-30" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-24 md:py-32">
          ...
          <h1 style={{ fontFamily: "'Barlow Condensed', sans-serif" }} className="text-5xl md:text-7xl font-extrabold text-white uppercase leading-none tracking-tight mb-4">
            Bridgeport Interceptor<br /><span style={{ color: "var(--fgi-blue)" }}>Storage Facility</span>
          </h1>
          <p className="text-white/70 text-lg max-w-xl leading-relaxed">
            Construction inspection and contract administration for a major wastewater storage facility built to capture wet-weather flows and reduce sewer overflows across Indianapolis.
          </p>
        </div>
      </section>
      ...
      <section style={{ backgroundColor: "var(--fgi-navy-dark)" }} className="py-8">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-6">
          {[
            ...
            { label: "Contractor", value: "Berkel & Company" },
            { label: "Location", value: "Indianapolis, IN" },
            { label: "Purpose", value: "Wet-Weather Storage" },
          ].map((item) => (
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="md:col-span-2">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              The Bridgeport Interceptor Storage Facility is a major wastewater infrastructure project for Citizens Energy Group, built to capture and store wet-weather flows, reduce sewer overflows, and strengthen the long-term reliability of Indianapolis' wastewater collection system. Farah &amp; Sons provided construction inspection and contract administration services throughout construction.
            </p>
            <p className="text-gray-600 leading-relaxed mb-4">
              Working alongside contractor Berkel &amp; Company Contractors and specialty subcontractors, our team monitored deep excavation support systems, soldier pile and lagging installation, quality control inspections, and underground pipeline construction. The work demanded close attention to the support-of-excavation systems holding back the surrounding ground as the facility was built.
            </p>
            <p className="text-gray-600 leading-relaxed">
              Inspection covered welded stud installations, lagging systems, structural support elements, large-diameter HDPE pipe fusion welding, pressure testing, leak detection, and riser assembly installations, all verified against project specifications. The completed facility will help capture and store wet-weather flows, improve environmental protection, and serve the collection system for decades to come.
            </p>

            <div className="mt-10 grid grid-cols-1 sm:grid-cols-3 gap-6">
              {[
                { stat: "Large-Dia.", label: "HDPE Fusion Welding" },
                { stat: "Deep", label: "Excavation Support" },
                { stat: "100%", label: "Spec Compliance Verified" },
              ].map((s) => (
          ...
          <div>
            <div style={{ backgroundColor: "#f4f6fb", borderTop: "3px solid var(--fgi-blue)" }} className="p-6 mb-6">
              ...
              <ul className="flex flex-col gap-2">
                {[
                  ...
                  "Deep excavation support monitoring",
                  "Soldier pile & lagging inspection",
                  "Welded stud installation inspection",
                  "HDPE pipe fusion weld inspection",
                  "Pressure testing & leak detection",
                  "Riser assembly inspection",
            ...
            <div style={{ backgroundColor: "var(--fgi-navy)" }} className="p-6">
              ...
              <ul className="flex flex-col gap-2 text-white/60 text-sm">
                <li>Contractor: Berkel &amp; Company Contractors</li>
                <li>Soldier pile &amp; lagging support of excavation</li>
                <li>Large-diameter HDPE pipe fusion welding</li>
                <li>Pressure testing &amp; leak detection</li>
                <li>Wet-weather flow capture &amp; storage</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section className="py-4 bg-white">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-3 gap-3">
          {gallery.map((src, i) => (
            <div key={i} className="relative h-48 md:h-72 overflow-hidden">
