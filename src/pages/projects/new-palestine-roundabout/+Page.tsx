const relatedProjects = [
  ...
  { title: "Taxiway G Rehabilitation", category: "Aviation", value: "Indianapolis Airport Authority", image: "/headpic3.webp", href: "/projects/taxiway-g-rehab" },
];
      ...
      <section className="relative overflow-hidden" style={{ backgroundColor: "var(--fgi-navy)", minHeight: "56vh" }}>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-24 md:py-32">
          ...
          <h1 style={{ fontFamily: "'Barlow Condensed', sans-serif" }} className="text-5xl md:text-7xl font-extrabold text-white uppercase leading-none tracking-tight mb-4">
            New Palestine<br /><span style={{ color: "var(--fgi-blue)" }}>Roundabout</span>
          </h1>
      ...
      <section style={{ backgroundColor: "var(--fgi-navy-dark)" }} className="py-8">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-6">
          {[
            ...
            { label: "Type", value: "Roundabout" },
            { label: "Location", value: "New Palestine, IN" },
            { label: "FGI Role", value: "Construction Inspection" },
          ].map((item) => (
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="md:col-span-2">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              Farah &amp; Sons provided construction inspection for a new roundabout in New Palestine, Indiana. Roundabouts improve intersection safety and keep traffic moving by replacing conventional stop-and-go control with a continuous-flow geometry, and their construction demands tight control of grading, drainage, and pavement to achieve the design alignment and cross-slopes.
            </p>
            <p className="text-gray-600 leading-relaxed">
              FGI's inspection covered earthwork, drainage, pavement, curb and sidewalk, and signing and pavement marking, verifying that the completed roundabout met the project plans, specifications, and agency standards.
            </p>
          </div>
          ...
          <div>
            <div style={{ backgroundColor: "#f4f6fb", borderTop: "3px solid var(--fgi-blue)" }} className="p-6 mb-6">
              ...
              <ul className="flex flex-col gap-2">
                {[
                  ...
                  "Earthwork & grading inspection",
                  "Drainage inspection",
                  "Pavement & curb inspection",
            ...
            <div style={{ backgroundColor: "var(--fgi-navy)" }} className="p-6">
              ...
              <ul className="flex flex-col gap-2 text-white/60 text-sm">
                <li>New roundabout intersection</li>
                <li>Improved safety &amp; traffic flow</li>
                <li>New Palestine, Indiana</li>
              </ul>
            </div>
          </div>
        </div>
