      ...
      <section className="relative overflow-hidden" style={{ backgroundColor: "var(--fgi-navy)", minHeight: "56vh" }}>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-24 md:py-32">
          ...
          <h1 style={{ fontFamily: "'Barlow Condensed', sans-serif" }} className="text-5xl md:text-7xl font-extrabold text-white uppercase leading-none tracking-tight mb-4">
            Primary Clarifiers 7&amp;8<br /><span style={{ color: "var(--fgi-blue)" }}>Rehabilitation</span>
          </h1>
          <p className="text-white/70 text-lg max-w-xl leading-relaxed">
            Rehabilitation of two additional primary clarifiers at the Belmont plant, continuing the restoration of aging primary treatment infrastructure for Citizens Energy Group.
          </p>
        </div>
      </section>
      ...
      <section style={{ backgroundColor: "var(--fgi-navy-dark)" }} className="py-8">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-6">
          {[
            ...
            { label: "Contract Value", value: "$2,205,000" },
            { label: "Project #", value: "92BE05071" },
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="md:col-span-2">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              Farah &amp; Sons provided construction inspection and contract administration for the rehabilitation of Primary Clarifiers 7 and 8 at the Belmont Advanced Wastewater Treatment Plant for Citizens Energy Group, continuing the program of primary clarifier restoration at the facility.
            </p>
            <p className="text-gray-600 leading-relaxed">
              The work renewed aging mechanical and structural components to keep these clarifiers in dependable service. FGI verified that construction met project plans and specifications, maintaining daily documentation, tracking quantities, and coordinating between the owner, contractor, and engineer through project closeout.
            </p>
          </div>
