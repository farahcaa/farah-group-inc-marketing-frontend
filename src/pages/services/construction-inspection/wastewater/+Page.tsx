const scope = [
  {
    title: "Structural & Sitework",
    description: "Inspection of basin construction, concrete tanks, buried pipelines, force mains, pump and lift stations, and structures across the plant and collection system.",
    icon: (
    ...
    <>
      <section className="relative overflow-hidden" style={{ backgroundColor: "var(--fgi-navy)", minHeight: "52vh" }}>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-24 md:py-32">
          ...
          <h1 style={{ fontFamily: "'Barlow Condensed', sans-serif" }} className="text-5xl md:text-7xl font-extrabold text-white uppercase leading-none tracking-tight mt-2 mb-4">
            Wastewater<br /><span style={{ color: "var(--fgi-blue)" }}>Inspection</span>
          </h1>
          <p className="text-white/70 text-lg max-w-xl leading-relaxed">
            Specialized construction inspection for wastewater treatment plants, lift stations, force mains, and collection systems, where quality control directly protects public health and the environment.
          </p>
        </div>
      </section>
      ...
      <section style={{ backgroundColor: "var(--fgi-navy-dark)" }} className="py-10">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            { label: "Facility Types", value: "Treatment Plants · Lift Stations · Force Mains" },
            { label: "Disciplines", value: "Structural · Mechanical · Electrical" },
            { label: "Delivery", value: "Resident & On-Call Inspection" },
          ].map((item) => (
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 style={{ fontFamily: "'Barlow Condensed', sans-serif" }} className="text-4xl font-extrabold text-white uppercase mb-6">
              Wastewater Work Demands a Higher Standard
            </h2>
            <p className="text-white/60 leading-relaxed mb-4">
              Unlike most infrastructure projects, defects in wastewater construction don't just cause schedule delays, they can compromise public health, trigger sewer overflows, and result in regulatory shutdowns. Our inspectors understand that the margin for error is essentially zero.
            </p>
            <p className="text-white/60 leading-relaxed">
              FGI brings inspectors with direct wastewater construction experience, not general construction backgrounds. That distinction matters when you're verifying an HDPE force main fusion weld, a deep-excavation support system, or a chlorine contact basin coating.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-8">
          <div>
            <h2 style={{ fontFamily: "'Barlow Condensed', sans-serif", color: "var(--fgi-navy)" }} className="text-4xl font-extrabold uppercase mb-2">
              Have a Wastewater Project?
            </h2>
            <p className="text-gray-500 text-sm">Let's talk about how FGI can provide the inspection coverage your facility deserves.</p>
          </div>
